...
*/
exports.uploadToken = functions
  .https
  .onRequest((request, response) => {
    cors(request, response, () => {
      Authentication
        .extractUidFromToken(request.query.token)
        .then((uid) => {
          return Storage
            .storageLeftInBytes(uid)
...
*/
exports.storageLeftInBytes = functions
  .https
  .onRequest((request, response) => {
    cors(request, response, () => {
      Authentication
...
*/
exports.deleteAllFiles = functions
  .https
  .onRequest((request, response) => {
    cors(request, response, () => {
      Authentication
